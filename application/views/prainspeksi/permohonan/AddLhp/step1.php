    <div class="container top">
      ...
      <ul class="breadcrumb">
		...
		<li>
		  <a href="<?php echo site_url("prainspeksi/permohonan"); ?>">
            Permohonan
          </a> 
          <span class="divider">/</span>
        </li>
		<li> <span class="icon icon-forward"></span> </li>
		<li class="active">
            Permohonan LHP Step 1
		</li>
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              foreach($manufacturers as $row)
              {
                ...
                echo '<td>
                  <a href="'.site_url("prainspeksi").'/gedung/update/'.$row['id'].'" class="btn btn-info">Pilih</a>
                </td>';
                echo '</tr>';
              }
              ?>      
