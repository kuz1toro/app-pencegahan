          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
				...
				<th class="yellow header headerSortDown">No Telp Pengelola</th>
				<th class="yellow header headerSortDown">Nama Gedung</th>
				<th class="yellow header headerSortDown">Tipe Permohonan</th>
				<th class="yellow header headerSortDown">No Permohonan</th>
				<th class="yellow header headerSortDown">Tgl Permohonan</th>
				<th class="yellow header headerSortDown">Tgl Surat Diterima</th>
              </tr>
            </thead>
            <tbody>
              <?php
              foreach($manufacturers as $row)
              {
				...
				echo '<td>'.$row['NoTelpPengelola'].'</td>';
				echo '<td>'.$row['NamaGedung_id'].'</td>';
				echo '<td>'.$row['TipePermhn'].'</td>';
				echo '<td>'.$row['NoPermhn'].'</td>';
				echo '<td>'.$row['TglPermhn'].'</td>';
				echo '<td>'.$row['TglSuratDiterima'].'</td>';
